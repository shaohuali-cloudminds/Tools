...
int main()
{
    ...
    *************************************************************************/   
		...
		for( int i = 0;  i != image_count ; i++)
    {
        ...
        StrStm << setw(4) << setfill('0') << i;
        StrStm>>imageFileName;
        imageFileName += ".png";
        cv::Mat image = imread("/home/shaohua/Workspace/Tools/vision/data/images/select"+imageFileName);
				imshow("Window", image);
				waitKey(0);
        /* 提取角点 */   
        Mat imageGray;
    ...
    cout<<"Corners Extracted！\n"; 
		cout << "Success Image number: " << successImageNum << endl;
    /************************************************************************  
           摄像机定标  
    *************************************************************************/   
    cout<<"Caliberating………………"<<endl;  
    ...
    *************************************************************************/   
    ...
    cout<<"Caliberation Errors："<<endl<<endl;   
    for (int i=0;  i<image_count;  i++) 
    {
        ...
        cout<<"No "<<i<<" image average error："<<err<<" pixels"<<endl;   
        fout<<"No "<<i<<" image average error："<<err<<" pixels"<<endl;   
    }   
    ...
    /************************************************************************  
           保存定标结果  
    *************************************************************************/   
    cout<<"Saving Caliberation Results………………"<<endl;       
    Mat rotation_matrix = Mat(3,3,CV_32FC1, Scalar::all(0)); /* 保存每幅图像的旋转矩阵 */   

    fout<<"Intrisic Parameters Matrix："<<endl;   
    fout<<intrinsic_matrix<<endl;   
    fout<<"Distortion Ratio：\n";   
    fout<<distortion_coeffs<<endl;   
    for (int i=0; i<image_count; i++) 
		{
        fout<<"No "<<i<<" image rotation vector："<<endl;   
        fout<<rotation_vectors[i]<<endl;   

        /* 将旋转向量转换为相对应的旋转矩阵 */   
        Rodrigues(rotation_vectors[i],rotation_matrix);   
        fout<<"No "<<i<<" image rotation matrix："<<endl;   
        fout<<rotation_matrix<<endl;   
        fout<<"No "<<i<<" image translation vector："<<endl;   
    ...
    *************************************************************************/
    ...
    cout<<"Saving Calibrated Images"<<endl;
    for (int i = 0 ; i != image_count ; i++)
    {
        cout<<"Frame #"<<i<<"..."<<endl;
